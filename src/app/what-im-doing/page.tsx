    ...
    <div className="min-h-screen p-8 pb-20 sm:p-20">
      ...
      <div className="max-w-3xl">
        <div className="mb-8">
          ...
          <div className="space-y-4">            <div className="bg-sage-light p-6 rounded-lg">
              ...
              <div className="flex items-center text-sm text-sage-dark">
                <span className="w-2 h-2 bg-sage-dark rounded-full mr-2"></span>
                In progress
              </div>
            </div>
              <div className="bg-sage-light p-6 rounded-lg">
        ...
        <div>
          ...
          <div className="space-y-4">            <div className="border-l-4 border-sage pl-4">
              <p className="text-sage text-sm">June 20, 2025</p>
            ...
            <div className="border-l-4 border-sage pl-4">
              <p className="text-sage text-sm">June 15, 2025</p>
